...
function Replies() {
  ...
  const getReplies = async (originalTxId) => {
    ...
    for (let i = 0; i < replyTypes.length; i++) {
      ...
      console.log({
        prefix,
        url: `https://testnet-idx.algonode.cloud/v2/accounts/K22E7O64EMVMBVPUQ53VVXN2U4WCYL7XN6PHOYMNNEBSNM6RMMKJZ3OAMI/transactions?note-prefix=${prefix}`,
      });
  ...
  return (
    <div>
      <Main pad="large">
        <Heading>
          <Text>
            <a href={"https://testnet.algoexplorer.io/tx/" + originalTxId}>
              {originalTxId}
            </a>
          </Text>
        </Heading>
        ...
        <Text>
          ...
          <a
            href={
              "https://testnet.algoexplorer.io/block/" +
        ...
        <Text>
          ...
          <a
            href={
              "https://testnet.algoexplorer.io/address/" + originalTx["sender"]
            }
          >
